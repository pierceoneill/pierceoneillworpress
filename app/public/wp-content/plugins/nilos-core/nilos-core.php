...
include_once(NILOS_ADDONS_DIR . '/include/custom-post-portfolio.php');
 ...
 * NILOS Custom Widget
*/
include_once(NILOS_WIDGET_PATH . '/nilos-blog-post-sidebar.php');
...
final class NILOS_Core {
	...
	public function admin_notice_missing_main_plugin() {
		...
		$message = sprintf(
			...
			esc_html__( '"%1$s" requires "%2$s" to be installed and activated.', 'nilos-core' ),
			'<strong>' . esc_html__( 'Nilos Core', 'nilos-core' ) . '</strong>',
			'<strong>' . esc_html__( 'Elementor', 'nilos-core' ) . '</strong>'
		);
	...
	public function admin_notice_minimum_elementor_version() {
		...
		$message = sprintf(
			...
			esc_html__( '"%1$s" requires "%2$s" version %3$s or greater.', 'nilos-core' ),
			'<strong>' . esc_html__( 'Nilos Core', 'nilos-core' ) . '</strong>',
			'<strong>' . esc_html__( 'Elementor', 'nilos-core' ) . '</strong>',
	...
	public function admin_notice_minimum_php_version() {
		...
		$message = sprintf(
			...
			esc_html__( '"%1$s" requires "%2$s" version %3$s or greater.', 'nilos-core' ),
			'<strong>' . esc_html__( 'Nilos Core', 'nilos-core' ) . '</strong>',
			'<strong>' . esc_html__( 'PHP', 'nilos-core' ) . '</strong>',
