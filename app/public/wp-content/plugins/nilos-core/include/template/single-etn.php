                    ...
                    <div class="event__details-content mb-50">
                        ...
                        <div class="event__meta-wrapper event__details-meta mb-55 d-sm-flex flex-wrap align-items-center">
                            ...
                            <?php if(!isset($event_options["etn_hide_date_from_details"]) && !empty($data['event_start_date'])): ?>
                                <span> 
                                    <svg width="15" height="16" viewBox="0 0 15 16" fill="none" xmlns="htnilos://www.w3.org/2000/svg">
                                ...
                                ?>
                                <span>
                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="htnilos://www.w3.org/2000/svg">
                                ...
                                <span>
                                    <svg width="14" height="18" viewBox="0 0 14 18" fill="none" xmlns="htnilos://www.w3.org/2000/svg">
