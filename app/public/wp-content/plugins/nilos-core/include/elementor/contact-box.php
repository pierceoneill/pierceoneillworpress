 ...
 * @since 1.0.0
 */
class NILOS_Contact_Box extends Widget_Base {
	...
	public function get_title() {
		return __( 'Contact Box', 'nilos-core' );
	}
	...
	protected function render() {
        ...
        <section class="contact-three">
            <div class="container">
                <div class="contact-three__curved-circle">
                    <div class="curved-circle">
                        <?php echo wp_kses_post($settings['nilos_contact_form_title']); ?>
                    </div><!-- /.curved-circle -->
                    <div class="contact-three__curved-circle-icon">
                        <h3>*</h3>
                    </div>
                </div><!-- /.curved-circle -->
...
$widgets_manager->register( new NILOS_Contact_Box() );
