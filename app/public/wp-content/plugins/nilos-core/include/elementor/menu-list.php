 ...
 * @since 1.0.0
 */
class NILOS_Mega_Menu_List extends Widget_Base {
	...
	public function get_title() {
		return __( 'Nilos Menus', 'nilos-core' );
	}
    ...
    protected function register_controls_section(){
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block' => true,
                'placeholder' => esc_html__('menu wrapper class', 'nilos-core'),
            ]
        );
...
$widgets_manager->register( new NILOS_Mega_Menu_List() );