<?php
namespace NilosCore\PageSettings;
...
class Page_Settings {
	...
	public function add_panel_tab() {
		Controls_Manager::add_tab( self::PANEL_TAB, __( 'New Tab', 'nilos-core' ) );
	}
	...
	public function register_document_controls( $document ) {
		...
		$document->add_control(
			'text',
			[
				'label' => __( 'Title', 'nilos-core' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Title', 'nilos-core' ),
			]
		);
