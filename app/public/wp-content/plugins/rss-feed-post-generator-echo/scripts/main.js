...
else
{
    ...
    jQuery("#spinnerchief").hide();
        ...
        if(jQuery("#spin_text option:selected").val() === 'builtin') 
        {      
            jQuery(".hideBuiltIn").show();
        }
        else
        {
            jQuery(".hideBuiltIn").hide();
        }
        if(jQuery("#spin_text option:selected").val() === 'spinrewriter') 
        {      
            jQuery(".hideSpinRewriter").show();
        }
        else
        {
            jQuery(".hideSpinRewriter").hide();
        }
        if(jQuery("#spin_text option:selected").val() === 'tldr') 
        {      
        ...
        if(jQuery('#send_email').is(":checked") || jQuery('#send_post_email').is(":checked"))
        {            
