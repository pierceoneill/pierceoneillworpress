...
<?php
            if(is_array($crawled_content))
            {
                ...
                echo '<tr><th>'.esc_html__("Feed URL", 'rss-feed-post-generator-echo').'</th><th>' . esc_html__("Website name", 'rss-feed-post-generator-echo').'</th></tr>';
                foreach($crawled_content as $cc)
                {
                    ...
                    echo '<a href="' . esc_url($cc['feedId']) . '" target="_blank">' . esc_url($cc['feedId']) . '</a>';
                    echo '</td><td class="tabel"><b>';
                    if(isset($cc['website']))
                    {
                        echo '<a href="' . esc_url($cc['website']) . '" target="_blank">';
                    }
                    if(isset($cc['title']))
                    {
