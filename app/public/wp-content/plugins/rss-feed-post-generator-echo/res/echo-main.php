   ...
   <div>
      <form id="myForm" method="post" action="<?php if(is_multisite() && is_network_admin()){echo '../options.php';}else{echo 'options.php';}?>">
         ...
         <?php
            ...
            if (isset($echo_Main_Settings['unsplash_api'])) {
                $unsplash_api = $echo_Main_Settings['unsplash_api'];
            } else {
                $unsplash_api = '';
            }
         ...
         <div>
            ...
            <div><?php if($echo_enabled != 'on'){echo '<div class="crf_bord cr_color_red cr_auto_update">' . esc_html__('This feature of the plugin is disabled! Please enable it from the above switch.', 'rss-feed-post-generator-echo') . '</div>';}?>
               <h3>
                  <ul>
                     <li><?php echo sprintf( wp_kses( __( 'Need help configuring this plugin? Please check out it\'s <a href="%s" target="_blank">video tutorial</a>.', 'rss-feed-post-generator-echo'), array(  'a' => array( 'href' => array(), 'target' => array() ) ) ), esc_url( 'https://www.youtube.com/watch?v=d9iIUjegP0o&list=PLEiGTaa0iBIhKwBdxZMUdHHY4XuXLvctE' ) );?>
                     </li>
                  ...
                  <tr>
                     <td colspan="2">
                        ...
                        <ul>
                           ...
                           <li>
                              <input type="submit" onclick="unsaved = false;" class="button button-primary" name="<?php echo esc_html($plugin_slug);?>_revoke_license" value="<?php echo esc_html__("Revoke License", 'rss-feed-post-generator-echo');?>">
                           </li>
                        </ul>
                        <?php
                           }
                 ...
                 <tr>
                    <td>
                       <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                          <div class="bws_hidden_help_text cr_min_260px">
                             <?php
                                echo esc_html__("Select if you want to enable usage of the Unsplash API for getting images.", 'rss-feed-post-generator-echo');
                                ?>
                          </div>
                       </div>
                       <b><?php esc_html_e('Enable Unsplash API Usage: ', 'rss-feed-post-generator-echo'); ?></b>
                    </td>
                    <td>
                       <input type="checkbox" name="echo_Main_Settings[unsplash_api]"<?php
                          if ($unsplash_api == 'on') {
                              echo ' checked="checked"';
                          }
                          ?> >
