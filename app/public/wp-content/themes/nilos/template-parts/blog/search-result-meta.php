<?php
    ...
    $author_name = get_the_author_meta( 'nilos_write_by');
    ...
    $nilos_url = get_the_author_meta( 'nilos_youtube' );
    ...
    $nilos_blog_view = get_theme_mod( 'nilos_blog_view', false );
...
?>
    ...
    <div class="nl-blog-grid-meta">
        <?php if ( !empty($nilos_blog_date) ): ?>
        <span>
            <span>
        ...
        <?php if ( !empty($nilos_blog_comments) ): ?>
        <span>
            <span>
                <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="<?php comments_link();?>"><?php echo esc_html__('Comments (', 'nilos') ?><?php echo get_comments_number();?><?php echo esc_html__(')', 'nilos') ?></a>
        </span>
        <?php endif;?>
